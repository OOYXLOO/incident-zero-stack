...
This package is a local no-secret prototype. It must not be submitted as a live H0 project until the account owner completes the official cloud gates.

## Required Before Final Submission

1. Confirm eligibility under the official H0 rules.
2. Authorize Vercel/v0 use for the frontend.
3. Authorize AWS account use, credits/billing controls, and database creation.
4. Create one of the designated AWS Databases: Aurora PostgreSQL, Aurora DSQL, or DynamoDB.
